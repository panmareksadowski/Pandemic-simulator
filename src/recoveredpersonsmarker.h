...
class RecoveredPersonsMarker : protected PeriodicallyInvoker {
  public:
    RecoveredPersonsMarker(PersonsList &personsList);

    void markRecoveredPersons(const std::chrono::nanoseconds &time);
