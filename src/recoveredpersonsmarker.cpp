...
RecoveredPersonsMarker::RecoveredPersonsMarker(PersonsList &personsList)
    : personsList(personsList) {}

void RecoveredPersonsMarker::markRecoveredPersons(const std::chrono::nanoseconds &time) {
    invokeAction(time);
}

void RecoveredPersonsMarker::action(const std::chrono::nanoseconds &time) {
    personsList.markRecoveredPersons(time);
}
